...
@section('page')
    ...
    ***IMPORTANT*** Any select form's default selection is decreased by one since the form begins at zero and
    ...
    <div class="row create-form">
        {{ Form::model($data.$telephones.$fin_aid.$addresses, array('id'=>'user_profile','route' => array('user_profile.update_personal_info', $data->id),
        ...
        @if($addresses)
            @foreach($addresses as $part)
                <div class="row form-group">
                    {{  Form::label('address1', 'Address part one', array('class' => 'control-label col-sm-2')) }}
                    <div class="col-sm-5">
                ...
                <div class="row form-group">
                    {{  Form::label('address2', 'Address part two', array('class' => 'control-label col-sm-2')) }}
                    <div class="col-sm-5">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {{  Form::text('email',$data->email, array('class' => 'form-control',
                                                'placeholder' => 'For Example: DoeJane@etsu.edu',
                                                'id' => 'email'))  }}
            </div>
        </div>
        @if($fin_aid)
        ...
        <div class="form-group padding-top-2">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a class="btn btn-default" href="{{URL::to('profile/'.$data->id.'/info')}}">Cancel</a>
            </div>
        </div>
        {{ Form::close() }}
    </div>
