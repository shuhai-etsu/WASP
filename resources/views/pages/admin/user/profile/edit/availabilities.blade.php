...
@section('page')
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active padding-top-2">
            <div class="row create-form">
                {{ Form::model($data, array('id'=>'user_profile','route' => array('user_profile.update_availabilities', $data->id, $availability->id),
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        {{ Form::input('time','start_time', $availability->start_time, array('class' => 'form-control'))  }}
                    </div>
                </div>
                <div class="form-group row">
                    {{ Form::label('end', 'End Time',['class'=>'col-xs-2 col-form-label'])  }}
                    <div class="col-sm-4">
                        {{ Form::input('time','end_time', $availability->end_time, array('class' => 'form-control'))  }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        {{ Form::select('semester', $semester, $availability->semester_id-1, array('class' => 'form-control')) }}
                    </div>
                </div>
                <div class="form-group row">
                    {{ Form::label('weekday', 'Weekday',['class'=>'col-xs-2 col-form-label'])  }}
                    <div class="col-sm-4">
                        {{ Form::select('weekday', $weekdays, $availability->weekday_id-1, array('class' => 'form-control')) }}
                    </div>
                </div>
                <hr/>
    ...
    @include('pages.modal.delete', array('item'=>(object)array('name' => 'this availability', 'type' => 'user_availabilities', 'id'=>$availability->id)))
