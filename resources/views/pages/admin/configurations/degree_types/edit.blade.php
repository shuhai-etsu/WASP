...
@section('page')
    ...
    <div class="row create-form">
        {{ Form::model($data, array('id'=>'configuration','route' => array('degree_types.update', $data->id),
    ...
    @include('pages.modal.delete', array('item'=>(object)array('name' => $data->description, 'type' => 'degree_types', 'id'=>$data->id)))
