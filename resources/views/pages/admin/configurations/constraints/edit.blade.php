...
@section('page')
    ...
    <div class="row create-form">
        {{ Form::model($data, array('id'=>'configuration','route' => array('constraints.update', $data->id),
        ...
        <div class="form-group padding-top-2">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a class="btn btn-default" href="{{URL::to('constraints')}}">Cancel</a>
            </div>
        </div>
        {{ Form::close() }}
    </div>
    @include('pages.modal.delete', array('item'=>(object)array('name' => $data->description, 'type' => 'constraints', 'id'=>$data->id)))
