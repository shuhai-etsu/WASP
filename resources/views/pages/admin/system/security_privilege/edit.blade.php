...
@section('page')
    ...
    <div class="row create-form">
        {{ Form::model($data, array('id'=>'configuration','route' => array('security_privilege_types.update', $data->id),
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {{  Form::text('description',null, array('class' => 'form-control',
                                                'placeholder' => 'For Example: Add, Update, Delete users',
                                                'id' => 'description'))  }}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group padding-top-2">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a class="btn btn-default" href="{{URL::to('security_privilege_types')}}">Cancel</a>
            </div>
        </div>
        {{ Form::close() }}
    </div>
    @include('pages.modal.delete', array('item'=>(object)array('name' => $data->description, 'type' => 'security_privilege_types', 'id'=>$data->id)))
