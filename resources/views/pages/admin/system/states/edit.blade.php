...
@section('page')
    ...
    <div class="row create-form">
        {{ Form::model($data, array('id'=>'configuration','route' => array('states.update', $data->id),
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {{  Form::text('description',null, array('class' => 'form-control',
                                                'placeholder' => 'For Example: Tennessee',
                                                'id' => 'description'))  }}
            </div>
        </div>
        <div class="form-group">
    ...
    @include('pages.modal.delete', array('item'=>(object)array('name' => $data->description, 'type' => 'states', 'id'=>$data->id)))
