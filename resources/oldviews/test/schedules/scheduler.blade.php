                        ...
                        [
                            {
                                type: "dayView",
                                showWeekends: false,
                                timeRuler: {hidden: false, scaleStartHour: 7, scaleEndHour: 17},
                                workTime: {fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 7, toHour: 18}
                            },
                            {
                                type: "weekView", showWeekends: false, timeRuler: {hidden: false},
                                showWeekends: false,
                                timeRuler: {hidden: false, scaleStartHour: 7, scaleEndHour: 17},
                                workTime: {fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 7, toHour: 17}
                            },
                            {
                            ...
                            },
                            {
                                ...
                                showWeekends: false,
                                timeRuler: {hidden: false, scaleStartHour: 7, scaleEndHour: 18},
                                workTime: {fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 7, toHour: 17}
                            }
                        ],
...
@section('content')
    ...
    <div class="container" style="width: 100%; height: 650px; margin-top: 5px;" id="container">
        ...
        <div class="form-group">
            <div class="col-sm-offset-12 col-sm-2" style="margin-right: 152px; margin-left: 100px;float:right;">
                <div>
