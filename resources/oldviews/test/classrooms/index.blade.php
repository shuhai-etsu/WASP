        ...
        $(document).ready(function ()
        {
            ...
            var source =
            {
                ...
                datafields: [{ name: 'id', type: 'string'},
                             ...
                             { name: 'minimum_students', type: 'string'},
                             { name: 'maximum_students', type: 'string'},
            ...
            {
                var path = "{!! url('/classrooms/') !!}" + "/" + JSON.parse(data)[row].id;
            ...
            $("#jqxgrid").jqxGrid(
                    {
                        ...
                        columns: [{ text: 'ID', datafield: 'id', width: 25, hidden:true },
                                  ...
                                  { text: 'Min Students', datafield: 'minimum_students', width: 100 },
                                  { text: 'Max Students', datafield: 'maximum_students', width: 100 },
