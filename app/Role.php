 ...
 * Class: Role
 *
 * Purpose: Class stores information associated with a given user's role within the application, such as
 *          Teacher, Student Worker, etc. The information is typically shown in drop down/pick lists and in reports.
 *
