 ...
 *
 * Purpose: Class stores information associated with a given work status type. A work status type is
 *          used to identify when a worker is present, absent, etc. from work. The information is typically shown in
 *          drop down/pick lists and in reports.
 *
 ...
 *
 */
class WorkStatusType extends Model
{
    use Auditable;
