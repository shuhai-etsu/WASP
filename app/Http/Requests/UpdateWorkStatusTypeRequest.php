...
/**
 * Class: UpdateWorkStatusTypeRequest
 *
 * Purpose: Class is used to validate an existing work status type entry based upon a defined set of rules. The class is
 *          called by the WorkStatusTypeController when a user attempts to update an existing work status type.
 *
 ...
 *
 */
class UpdateWorkStatusTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:work_status_types,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:work_status_types,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:work_status_types,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
