...
/**
 * Class: UpdateGenderTypeRequest
 *
 * Purpose: Class is used to validate an existing gender entry based upon a defined set of rules. The class is called by
 *          the GenderController when a user attempts to update an existing gender.
 *
 * @see GenderController
 *
...
class UpdateGenderRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:genders,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:genders,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:genders,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
