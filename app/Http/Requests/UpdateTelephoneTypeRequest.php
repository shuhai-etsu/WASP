...
/**
 * Class: UpdateTelephoneTypeRequest
 *
 * Purpose: Class is used to validate an existing telephone type entry based upon a defined set of rules. The class is
 *          called by the TelephoneTypeController when a user attempts to update an existing telephone type.
 *
 * @see TelephoneTypeController
 *
 ...
 *
 */
class UpdateTelephoneTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:telephone_types,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:telephone_types,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:telephone_types,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
