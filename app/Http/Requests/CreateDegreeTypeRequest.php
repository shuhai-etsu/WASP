...
/**
 * Class: CreateDegreeTypeRequest
 *
 * Purpose: Class is used to validate a new degree type entry based upon a defined set of rules before the entry
 *          is added to the database. The class is called by the DegreeTypeController when a user attempts to add a
 *          new degree type to the system.
 *
 ...
 *
 */
class CreateDegreeTypeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'abbreviation' => 'required|min:1|unique:degree_types,abbreviation',
            'description'  => 'required|min:1|unique:degree_types,description',
            'comment' => 'max:255'
        ];
    }
}
