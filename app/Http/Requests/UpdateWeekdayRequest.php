...
/**
 * Class: UpdateWeekdayRequest
 *
 * Purpose: Class is used to validate an existing weekday entry based upon a defined set of rules. The class is
 *          called by the WeekdayController when a user attempts to update an existing weekday.
 *
...
class UpdateWeekdayRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:weekdays,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:weekdays,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:weekdays,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
