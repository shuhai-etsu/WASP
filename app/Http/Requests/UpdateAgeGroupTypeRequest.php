...
/**
 * Class: UpdateAgeGroupTypeRequest
 *
 * Purpose: Class is used to validate an existing age group type entry based upon a defined set of rules. The class is
 *          called by the AgeGroupTypeController when a user attempts to update an existing age group type.
 *
 * @see AgeGroupTypeController
 *
...
class UpdateAgeGroupTypeRequest extends FormRequest
{
    /**
     ...
     *
     * @todo why does the rules logic below reference degree_types??
     *
