...
/**
 * Class: CreateSuffixRequest
 *
 * Purpose: Class is used to validate a new suffix entry based upon a defined set of rules. The class is called by the
 *          SuffixController when a user attempts to add a new suffix to the system.
 *
...
class CreateSuffixRequest extends FormRequest
{
    ...
    {
        return [
            'abbreviation'  => 'required|min:1|unique:suffixes,abbreviation',
            'description'   => 'required|min:1|unique:suffixes,description',
            'comment'       => 'max:255'
        ];
    }
}
