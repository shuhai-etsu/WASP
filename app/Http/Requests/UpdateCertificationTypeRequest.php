...
/**
 * Class: UpdateCertificationTypeRequest
 *
 * Purpose: Class is used to validate an existing certification type entry based upon a defined set of rules. The class
 *          is called by the CertificationTypeController when a user attempts to update an existing certification type.
 *
 * @see CertficationTypeController
 *
...
class UpdateCertificationTypeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            //==========================================================================================================
            'id'            => 'exists:certification_types,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:certification_types,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:certification_types,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
