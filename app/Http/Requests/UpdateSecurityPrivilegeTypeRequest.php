...
/**
 * Class: UpdateSecurityPrivilegeTypeRequest
 *
 * Purpose: Class is used to validate an existing security privilege type entry based upon a defined set of rules. The 
 *          class is called by the SecurityTypeController when a user attempts to update an existing security privilege 
 *          type.
 *
 ...
 *
 */
class UpdateSecurityPrivilegeTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:security_privilege_types,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:security_privilege_types,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:security_privilege_types,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
