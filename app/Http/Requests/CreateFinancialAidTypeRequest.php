...
/**
 * Class: CreateFinancialAidTypeRequest
 *
 * Purpose: Class is used to validate a new financial aid type entry based upon a defined set of rules. The class is
 *          called by the FinancialAidTypeController when a user attempts to add a new financial aid type to the system.
 *
 ...
 *
 */
class CreateFinancialAidTypeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'abbreviation'  => 'required|min:1|unique:financial_aid_types,abbreviation',
            'max_hours'     => 'required|integer',
            'description'   => 'required|min:1|unique:financial_aid_types,description',
            'comment'       => 'max:255'
        ];
    }
}
