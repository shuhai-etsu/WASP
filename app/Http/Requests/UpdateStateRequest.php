 ...
 *
 * Purpose: Class is used to validate an existing state entry based upon a defined set of rules. The class is called by
 *          the StateController when a user attempts to update an existing state.
 *
 * @see StateController
 *
...
class UpdateStateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            //==========================================================================================================
            'id'            => 'exists:states,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:states,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:states,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
