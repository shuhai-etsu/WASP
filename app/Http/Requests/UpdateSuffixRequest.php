...
/**
 * Class: UpdateSuffixRequest
 *
 * Purpose: Class is used to validate an existing suffix entry based upon a defined set of rules. The class is called by
 *          the SuffixController when a user attempts to update an existing suffix.
 *
 * @see SuffixController
 *
...
class UpdateSuffixRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            //==========================================================================================================
            'id'            => 'exists:suffixes,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:suffixes,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:suffixes,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
