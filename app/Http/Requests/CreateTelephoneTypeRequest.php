...
/**
 * Class: CreateTelephoneTypeRequest
 *
 * Purpose: Class is used to validate a new telephone type entry based upon a defined set of rules. The class is called
 *          by the TelephoneTypeController when a user attempts to add a new telephone type to the system.
 *
 ...
 *
 */
class CreateTelephoneTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return 
        [
            'abbreviation'  => 'required|min:1|unique:telephone_types,abbreviation',
            'description'   => 'required|min:1|unique:telephone_types,description',
            'comment'       => 'max:255'
        ];
    }
}
