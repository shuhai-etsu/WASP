 ...
 *
 * Purpose: Class is used to validate an existing constraint entry based upon a defined set of rules. The class is
 *          called by the ConstraintsController when a user attempts to update an existing constraint.
 *
 * @see ConstraintsController
 *
 ...
 *
 */
class UpdateConstraintRequest extends FormRequest
{
    /**
     ...
     *
     * @todo why does this function reference degree_types when the table is called constraints?
     *
    ...
    public function rules()
    {
        ...
        [
            ...
            //to determine if the id of the incoming constraint exists in the database, similar to saying
            //SELECT id from constraint WHERE id = {incoming id}.
            //==========================================================================================================
