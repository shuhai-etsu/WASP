 ...
 *
 * Purpose: Class is used to validate an existing role entry based upon a defined set of rules. The class is called by
 *          the RoleController when a user attempts to update an existing role.
 *
 * @see RoleController
 *
...
class UpdateRoleRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:roles,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:roles,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:roles,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
