 ...
 *
 * Purpose: Class is used to validate an existing relationship entry based upon a defined set of rules. The class is
 *          called by the RelationshipController when a user attempts to update an existing relationship.
 *
...
class UpdateRelationshipRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        [
            ...
            //==========================================================================================================
            'id'            => 'exists:relationships,id,id,' . $this->get('id'),
            'abbreviation'  => 'required|min:1|unique:relationships,abbreviation,' . $this->get('id'),
            'description'   => 'required|min:1|unique:relationships,description,'  . $this->get('id'),
            'comment'       => 'max:255'
        ];
    }
}
