 ...
 *
 * Purpose: Class is used create and drop the States table, which stores information on the states and territories that
 *          compose the United States.
 *
    ...
    public function up()
    {
        Schema::create('states', function (Blueprint $table)
        {
            ...
            $table->string('abbreviation', 10)
                  ->unique()
                  ->comment = 'Abbreviation of a given state or territory, such as TN for Tennessee.';
            
            $table->string('description', 25)
                  ->unique()
                  ->comment = 'Description of a given state or territory, such as Tennessee.';
            
            $table->string('comment', 255)
                  ->nullable()
                  ->comment = 'Brief comment about the state or territory entry.';
