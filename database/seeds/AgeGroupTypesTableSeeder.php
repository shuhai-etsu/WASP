 ...
 *      ----------------------------------------------------------------------------------------------------------------
 */
class AgeGroupTypesTableSeeder extends Seeder
{
    /**
     * Function: run()
     *
     ...
     *
     *   -.  /database/seeds/default/age_group_types.txt - initial values for age_group_types table,
     *       formatted as
    ...
    public function run()
    {
        PickListTableSeeder::run("/database/seeds/default/age_group_types.txt","age_group_types");
    }
}
