 ...
 *
 * Purpose: Seeds the countries table with default data.
 *
 * Requirement(s):
 *
 *      Document                            Section
...
class CountriesTableSeeder extends Seeder
{
     ...
     *
     *   -.  /database/seeds/default/countries.txt - initial values for countries table,
     *       formatted as
    ...
    public function run()
    {
        PickListTableSeeder::run("/database/seeds/default/countries.txt","countries");
    }
}
