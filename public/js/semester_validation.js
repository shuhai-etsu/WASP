 ...
 *
 * JQuery code which is included in create and edit pages of semesters
 * It is executed when the JQuery library has been loaded and elements have been rendered on the browser
 *
 */
$(document).ready(function () {
    //add datepicker on start and end dates
    $('#start_date').jqxDateTimeInput({formatString: "MM/dd/yyyy"});
    $('#end_date').jqxDateTimeInput({formatString: "MM/dd/yyyy"});
